        ...
        <div className="rounded-3xl border border-slate-200 bg-white p-8 shadow-sm text-center">
          ...
          {payState === "bp_done" && (
            <div className="mt-6 rounded-2xl border border-emerald-200 bg-emerald-50 px-4 py-4">
              <p className="text-sm font-bold text-emerald-700">5000BP の支払いが完了しました！</p>
          ...
          {payState === "ep_done" && (
            <div className="mt-6 rounded-2xl border border-emerald-200 bg-emerald-50 px-4 py-4">
              <p className="text-sm font-bold text-emerald-700">2000EP の支払いが完了しました！</p>
              <p className="mt-1 text-xs text-emerald-600">代理申請の手続きを進めます。完了次第ご連絡いたします。</p>
            </div>
          )}
            ...
            <div className="mt-6 space-y-3">
              ...
              {NARASU_BP_PAYMENT_SUSPENDED ? (
                ...
                >
                  ...
                  <p className="mt-0.5 text-xs text-indigo-600">5000BP消費 — 即時完了</p>
                </button>
              )}
              ...
              >
                ...
                <p className="mt-0.5 text-xs text-violet-600">2000EP消費 — 即時完了</p>
              </button>
