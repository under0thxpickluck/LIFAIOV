...
人員体制およびご依頼状況を踏まえた品質維持のため、現在BP払いを一時的に停止しております。当面のお支払いはEP払い（1000EP）をご利用ください。再開する場合は改めてご案内いたします。

■ 処理スケジュールについて

narasu配信代理申請は、以下のスケジュールを目安に処理いたします。

・毎月1日〜10日のお申し込み：当月内の処理
・毎月11日以降のお申し込み：翌月中の処理
